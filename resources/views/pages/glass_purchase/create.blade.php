<x-admin title="Glass Purchase">
    {{-- <x-page-header head="Doctor" /> --}}
    <x-card header="Glass Purchase" links="{{ route('pathology.patient.index') }}" title="Patient List">
        <x-form  method="post" action="{{ route('glass.purchase.store') }}">
            <div class="row">
                <div class="col-md-8">
                    <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <button type="submit" class="btn btn-sm btn-primary mt-3"><i
                                                        class="fa fa-save"></i>
                                                    Save</button>
                    <a href="{{ route('medicine.purchase.create') }}"  class="btn btn-sm btn-success float-right mt-3">Clear form</a>
                </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $(document).on('change', '#lens', function () {
                    ...
                    $.get("/pharmacy/glass/purchase/find_medicine/" + selectedValue, function (data) {
                        $('#test_table').append(`
