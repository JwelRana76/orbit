    ...
    <table style="width:100%;border-collapse:collapse;margin-bottom:20px;">
        <tr>
            ...
            <td style="width:60%;vertical-align:top;">
                ...
                <h2 style="margin:0;color:#0d6efd;">{{$sale->customer->name}}</h2>
            ...
            <td style="width:40%;vertical-align:top;text-align:right;">
                ...
                <table style="width:100%;margin-top:15px;">
                    <tr>
                        <td style="padding:4px;"><b>SaleId</b></td>
                        <td style="padding:4px;">:</td>
                        <td style="padding:4px;text-align:right;">{{$sale->saleid}}</td>
                    </tr>

                    <tr>
                        <td style="padding:4px;"><b>Date</b></td>
                        <td style="padding:4px;">:</td>
                        <td style="padding:4px;text-align:right;">{{$sale->created_at->format('d-M-Y')}}</td>
                    </tr>

                    <tr>
                        <td style="padding:4px;"><b>sale By</b></td>
                        <td style="padding:4px;">:</td>
                        <td style="padding:4px;text-align:right;">{{$sale->user->name}}</td>
                    </tr>
        ...
        <tbody>
            @foreach ($sale->items as $key=>$item)
                <tr>
                    ...
                    <td style="border:1px solid #999;padding:10px;">{{ucwords(strtolower($item->medicine->name))}}</td>
            ...
            <td style="width:45%;">
                ...
                <table style="width:100%;border-collapse:collapse;">
                    ...
                    <tr>
                        ...
                        <td style="border:1px solid #999;padding:8px;text-align:right;">{{$sale->total_price}}</td>
                    ...
                    <tr>
                        ...
                        <td style="border:1px solid #999;padding:8px;text-align:right;">{{$sale->discount}}</td>
                    ...
                    <tr>
                        ...
                        <td style="border:1px solid #999;padding:8px;background:#f4f4f4;text-align:right;"><b>{{$sale->grand_total}}</b></td>
                    ...
                    <tr>
                        ...
                        <td style="border:1px solid #999;padding:8px;text-align:right;">{{$sale->paid}}</td>
                    ...
                    <tr>
                        ...
                        <td style="border:1px solid #999;padding:8px;text-align:right;color:red;"><b>{{$sale->grand_total - $sale->paid}}</b></td>
