<x-admin title="Lens Purchase">
    ...
    <x-card header="Lens Purchase" links="{{ route('pathology.patient.index') }}" title="Patient List">
        <x-form  method="post" action="{{ route('lens.purchase.update',$purchase->id) }}">
            <div class="row">
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <x-select id="supplier" :options="$supplier" selectedId="{{ $purchase->lens_supplier_id }}" required />
                        </div>
                        <div class="col-md-12">
