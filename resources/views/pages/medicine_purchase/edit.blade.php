<x-admin title="Medicine Purchase Edit">
    ...
    <x-card header="Medicine Purchase Edit" links="{{ route('pathology.patient.index') }}" title="Patient List">
        <x-form  method="post" action="{{ route('medicine.purchase.update',$purchase->id) }}">
            <div class="row">
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <x-select id="supplier" :options="$supplier" selectedId="{{ $purchase->medicine_supplier_id }}" required />
                        </div>
                        <div class="col-md-12">
                            ...
                            <tbody id="test_table">
                                @foreach ($purchase->items as $key=>$item)
                                    <tr data-test-id="">
                                        ...
                                        <td>{{$item->price}}</td>
                                        <td><input type="number" value="{{$item->bonus}}" name="bonus[]" class="form-control" value="0" min="0"></td>
