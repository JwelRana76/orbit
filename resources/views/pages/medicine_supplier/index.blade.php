<x-admin title="Medicine Supplier">
    <x-page-header head="Medicine Supplier" />
    <div class="row">
        <div class="col-md-3">
            <div class="card p-3">
                <x-form method="post" action="{{ route('medicine.supplier.store') }}">
        ...
        <div class="col-md-9">
            <x-data-table dataUrl="pharmacy/medicine/supplier" id="medicinesuppliers" :columns="$columns" />
        </div>
    </div>
    ...
    <div class="modal fade" id="paymentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <x-form method="post" action="{{ route('medicine.supplier.payment') }}">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#paymentDetails').on('show.bs.modal', function (event) {
                    ...
                    $.get("/pharmacy/medicine/supplier/payment/details/" + id, function (data) {
                        ...
                        $.each(data, function(index, item) {
                            tbody.append(`
                                <tr>
                                    ...
                                    <td>${item.amount}</td>
                                    <td>
                                        <a onclick="return confirm('Are you sure to Delete this record..??')" href="{{ url('pharmacy/medicine/purchase/paymentdelete') }}/${item.id}">
