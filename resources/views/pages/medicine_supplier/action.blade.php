...
<div class="btn-group dropleft">
    ...
    <div class="dropdown-menu">
        ...
        <a class="dropdown-item" href="{{ route('medicine.supplier.edit',base64_encode($item->id)) }}" ><i class="fa fa-fw text-primary fa-pen-nib"></i> Edit</a>
        {{-- @endif --}}
        @if ($item->due > 0)
        ...
        <a class="dropdown-item" href="{{ route('medicine.supplier.delete',base64_encode($item->id)) }}" onclick="return confirm('Are you sure to Delete this record..??')"><i class="fa fa-fw text-danger fa-trash"></i> Delete</a>
        {{-- @endif --}}
    </div>   
</div>