<x-admin title="Frame Purchase Edit">
    {{-- <x-page-header head="Doctor" /> --}}
    <x-card header="Frame Purchase Edit" links="{{ route('pathology.patient.index') }}" title="Patient List">
        <x-form  method="post" action="{{ route('frame.purchase.update',$purchase->id) }}">
            <div class="row">
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <x-select id="supplier" :options="$supplier" selectedId="{{ $purchase->frame_supplier_id }}" required />
                        </div>
                        <div class="col-md-12">
