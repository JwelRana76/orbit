<x-admin title="Glass Supplier">
    <x-page-header head="Glass Supplier" />
    <div class="row">
        <div class="col-md-3">
            <div class="card p-3">
                <x-form method="post" action="{{ route('glass.supplier.store') }}">
        ...
        <div class="col-md-9">
            <x-data-table dataUrl="pharmacy/glass/supplier" id="glasssuppliers" :columns="$columns" />
        </div>
    </div>
    ...
    <div class="modal fade" id="paymentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <x-form method="post" action="{{ route('glass.supplier.payment') }}">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#paymentDetails').on('show.bs.modal', function (event) {
                    ...
                    $.get("/pharmacy/glass/supplier/payment/details/" + id, function (data) {
                        ...
                        $.each(data, function(index, item) {
                            tbody.append(`
                                <tr>
                                    ...
                                    <td>${item.amount}</td>
                                    <td>
                                        <a onclick="return confirm('Are you sure to Delete this record..??')" href="{{ url('pharmacy/glass/purchase/paymentdelete') }}/${item.id}">
